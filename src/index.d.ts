import {IGetRowsParams,ColDef,ColGroupDef,ColumnVO } from '@ag-grid-community/all-modules'
...
export interface OdataQueryExtendOptions extends OdataProviderOptions{
    skip : number;
    top : number;
}
...
export declare class OdataProviderOptions {
   ...
   */
  beforeRequest: (options: OdataQueryOptions,provider: OdataProvider,request: IGetRowsParams) => void;
  /**
...
export declare class OdataProvider {
     ...
     */
    private getFilterOdata(colName: string, col: ColumnVO): string
    /**
    ...
    /**
     * Extartc values from odata responce
     * @param responce 
     */
    private getOdataResult(responce: any): any;
    /**
